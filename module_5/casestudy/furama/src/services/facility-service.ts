...
export class FacilityService {
  public  getFacilityList(){
    ...
    facilityList = [
      new Facility(1, 2, 'DV-001', 'Phòng Superior hướng hồ', 40.1,
        300, 4, 'Vip', 'View hồ, tivi 40 inch' , 3 ,
        15 , 0 , 'https://furamavietnam.com/wp-content/uploads/2018/03/Vietnam_Danang_Furama_Lagoon-Superior-twin-bed-F-370x239.jpg'),
