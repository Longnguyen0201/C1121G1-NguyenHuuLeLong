...
public class CustomerDto implements Validator {
    ...
    public void validate(Object target, Errors errors) {
        ...
        Customer customer = this.iCustomerService.findByCustomerCode(customerCurrentCode);
        if (customer!= null){
            if(customer.getCustomerCode().equals(customerCurrentCode)){
                errors.rejectValue("customerCode","customer.code",
                        "Code already used, please enter another Code .");
            }
        }
    }
}
