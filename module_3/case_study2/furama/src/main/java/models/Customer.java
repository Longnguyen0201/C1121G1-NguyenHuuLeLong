...
public class Customer extends Person {
    ...
    public Customer(Integer id, String code,String name, String birthday, Integer gender,String idCard, String phone, String email, String address,   Integer customerTypeId) {
