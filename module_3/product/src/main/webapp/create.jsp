            ...
            <div class="contact-form">
                ...
                <form method="post" class="needs-validation" novalidate>
                    <div class="form-group">
                        ...
                        <input type="text" name="name" class="form-control" pattern="^[\p{Lu}\p{Ll}]+( [\p{Lu}\p{Ll}]+)*$" required>
                        <div class="valid-feedback">Valid</div>
                        <div class="invalid-feedback">Name cannot have any extra spaces or no characters</div>
                    </div>
                    <div class="form-group">
                        <label>Price Product</label>
                        <input type="number" name="price" class="form-control" required min="10000000">
                        <div class="valid-feedback">Valid</div>
                    ...
                    <div class="row">
                        <div class="col-sm-4">
                            <div class="form-group">
                                ...
                                <input type="number" name="quantity" class="form-control" min="0" required pattern="^\d+(.\d+)*$">
                                <div class="valid-feedback">Valid</div>
