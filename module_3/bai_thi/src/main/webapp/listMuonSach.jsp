    ...
    <div class="table-responsive">
        <div class="table-wrapper">
            ...
            <table class="table table-striped table-hover" id="example">
                ...
                <tbody>
                <c:forEach var="themuonsach" items="${list}" varStatus="l">
                    <tr>
                        <td>${themuonsach.maMuonSach}</td>
                        <td>${themuonsach.maSach}</td>
                        <td>${themuonsach.tenTacGia}</td>
                        <td>${themuonsach.tenHocSinh}</td>
                        <td>${themuonsach.lop}</td>
                        <td>${themuonsach.ngayMuonSach}</td>
                        <td>${themuonsach.ngayTraSach}</td>

                        <td>
                            <a href="/sachs?action=muon&id=${Sathemuonsachch.maMuonSach}">
